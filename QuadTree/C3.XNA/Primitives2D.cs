...
namespace C3.XNA
{
    ...
    public static class Primitives2D
    {
        ...
        public static void PutPixel(this SpriteBatch spriteBatch, float x, float y, Color color, int size = 1)
        {
            PutPixel(spriteBatch, new Vector2(x, y), color, size);
        }

        public static void PutPixel(this SpriteBatch spriteBatch, Vector2 position, Color color, int size = 1)
        {
            if (pixel == null)
            {
                CreateThePixel(spriteBatch);
            ...
            spriteBatch.Draw(pixel,
                new Rectangle((int)(position.X - size / 2),
        ...
        #region PutDot
        public static void PutDot(this SpriteBatch spriteBatch, float x, float y, Color color, int size = 1)
        {
            PutDot(spriteBatch, new Vector2(x, y), color, size);
        }

        public static void PutDot(this SpriteBatch spriteBatch, Vector2 position, Color color, int size = 1)
        {
            spriteBatch.Draw(Art.Dot16,
                new Rectangle((int)(position.X - size / 2),
                              (int)(position.Y - size / 2),
                              size,
                              size),
